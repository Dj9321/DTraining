...
public class TestMainFive {
	...
	public static void main(String[] args) throws java.lang.Exception {
		...
		/*
		 * To swap elements of Java ArrayList use, static void swap(List list, int
		 * firstElement, int secondElement) method of Collections class. Where
		 * firstElement is the index of first element to be swapped and secondElement is
		 * the index of the second element to be swapped.
		 * 
		 * If the specified positions are equal, list remains unchanged.
		 * 
		 * Please note that, this method can throw IndexOutOfBoundsException if any of
		 * the index values is not in range.
		 */
